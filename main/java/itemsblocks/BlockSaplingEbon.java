...
public class BlockSaplingEbon extends BlockBush implements IGrowable
{
    ...
    public boolean canBlockStay(World p_149718_1_, int p_149718_2_, int p_149718_3_, int p_149718_4_)
    {
        if (p_149718_3_ >= 0 && p_149718_3_ < 256)
        {
            ...
            return block == Blocks.netherrack || block == Blocks.soul_sand && p_149718_1_.getBlockMetadata(p_149718_2_, p_149718_3_ - 1, p_149718_4_) == 2 || p_149718_1_.getFullBlockLightValue(p_149718_2_, p_149718_3_, p_149718_4_) < 13 && block.canSustainPlant(p_149718_1_, p_149718_2_, p_149718_3_ - 1, p_149718_4_, ForgeDirection.UP, this);
        }
        else
        {
            return false;
    ...
    public boolean func_149884_c(World p_149884_1_, int p_149884_2_, int p_149884_3_, int p_149884_4_, Random p_149884_5_)
    {
        ...
        WorldGenEbonTree worldgenbigmushroom = null;

        if (this == Mainclass.EbonSapling)
        {
            worldgenbigmushroom = new WorldGenEbonTree(blockConstructorCalled, 0, l, l);
        }
