...
public class WorldGenEbonTree extends WorldGenAbstractTree {
    ...
    public WorldGenEbonTree(boolean var1) {
        this(var1, rand.nextInt(4) + 4, 0, 0);
    }

    public WorldGenEbonTree(boolean var1, int var2, int var3, int var4) {
        super(var1);
                ...
                if (isSoil && par4 < 256 - l - 1) {
                            ...
                            for (int k2 = par5 - l1; k2 <= par5 + l1; ++k2) {
                                ...
                                if (Math.abs(j2) != l1 || Math.abs(l2) != l1 || par2Random.nextInt(2) != 0 && i3 != 0) {
                                    ...
                                    if (block1.isAir(par1World, i2, k1, k2) || block1.isLeaves(par1World, i2, k1, k2)) {
                                        this.setBlockAndNotifyAdequately(par1World, i2, k1, k2,Mainclass.EbonLeaves, this.metaLeaves);
                                    }
                                }
                            }
                        }
                    ...
                    for (k1 = 0; k1 < l; ++k1) {
                        ...
                        if (block.isAir(par1World, par3, par4 + k1, par5) || block.isLeaves(par1World, par3, par4 + k1, par5)) {
                            this.setBlockAndNotifyAdequately(par1World, par3, par4 + k1, par5, Mainclass.EbonLog, this.metaWood);
